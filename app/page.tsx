...
export default function Home() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#050505] text-zinc-400 selection:bg-primary selection:text-primary-foreground font-sans antialiased">
      ...
      {/* Banner */}
      <div className="fixed top-0 left-0 right-0 z-50 bg-white text-black h-8 flex items-center justify-center text-[10px] font-mono uppercase tracking-[0.2em]">
        Currently there are only Linux builds. macOS and Windows are coming
        soon.
      </div>
